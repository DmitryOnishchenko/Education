...
import com.donishchenko.testgame.utils.SpriteSheet;
...
public class AssetsOld {
    ...
    private static final String UNITS_PROPERTIES_PATH = "/units/properties/";
    ...
    private static void loadAssetsForUnit(String unitName) {
        try {
            /* Load from .json */
            InputStream in = Application.class.getResourceAsStream(UNITS_PROPERTIES_PATH + unitName + ".json");
...
//        BufferedImage background = ImageUtils.loadImage(MainApp.class, "/res/background/battle_panel_background.png");
        BufferedImage background0 = ImageUtils.loadImage(Application.class, "/res/background/map_ideal_0.png");
        BufferedImage background1 = ImageUtils.loadImage(Application.class, "/res/background/map_ideal_1.png");
        commonAssets.put("background0", background0);
        commonAssets.put("background1", background1);
        /* Floor */
        BufferedImage floor = ImageUtils.loadImage(Application.class, "/res/background/floor.png");
    ...
    private static void loadEffectsAssets() {
        ...
        try {
            for (int i = 0; i < 8; i++) {
                BufferedImage img = ImageIO.read(Application.class.getResource("/res/blood/blood_" + i + ".png"));
    ...
    private static void loadProjectilesAssets() {
        ...
        BufferedImage woodenArrow = ImageUtils.loadImage(Application.class, "/res/projectiles/wooden_arrow.png");
    ...
    private static VolatileImage[] getSprites(JSONObject json, String name) {
        ...
        SpriteSheet spriteSheet = new SpriteSheet(ImageUtils.loadImage(Application.class, spritesFile));
